...
class _ExplorePageState extends State<ExplorePage> {
  ...
  Widget _buildFeaturedBooksPreview() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
        ...
        StreamBuilder<QuerySnapshot>(
          stream: _databaseService.getNewReleases(),
          builder: (context, snapshot) {
            ...
            final books = snapshot.data!.docs.take(2).toList();
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    ...
                    child: _buildBookPreviewCard(book),
                  );
                },
              ),
            );
  ...
  Widget _buildBookPreviewCard(Map<String, dynamic> book) {
    return Card(
      elevation: 4,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
      child: Column(
